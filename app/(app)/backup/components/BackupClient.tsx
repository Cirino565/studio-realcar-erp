...
const grupos = [
  ...
  {
    titulo: "Crescimento",
    itens: ["leads", "interacoesLeads", "campanhas", "fornecedores"] as const,
  },
  {
    titulo: "Cadastros",
    itens: [
...
const nomesMetricas: Record<keyof Omit<BackupMetricas, "total">, string> = {
  clientes: "Clientes",
  origensCliente: "Origens de cliente",
  procedimentosInteresse: "Interesses",
  procedimentosServico: "Serviços",
  profissionais: "Profissionais",
  agendamentos: "Agendamentos",
  bloqueiosAgenda: "Bloqueios de agenda",
  lancamentos: "Lançamentos",
  fornecedores: "Fornecedores",
  produtos: "Produtos",
  kitsProdutos: "Kits de produtos",
  kitsProdutosItens: "Itens configurados em kits",
  movimentacoes: "Movimentações",
  compras: "Compras",
  compraItens: "Itens de compra",
  leads: "Leads",
  interacoesLeads: "Interações de leads",
  campanhas: "Campanhas",
  usuarios: "Usuários",
  perfis: "Perfis",
  permissoes: "Permissões",
  perfilPermissoes: "Vínculos de permissões",
  automacoes: "Automações",
  mensagemModelos: "Modelos de mensagem",
